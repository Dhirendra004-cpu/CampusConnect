...
import { Loader2, LayoutDashboard, Newspaper, Calendar, LogOut, Building2, Users } from "lucide-react";
    ...
    <SidebarProvider>
      <Sidebar side="left" collapsible="icon">
        <SidebarHeader className="border-b border-sidebar-border">
          <Link href="/admin/dashboard" className="flex items-center gap-2 text-primary-foreground/90 hover:text-primary-foreground">
            <Building2 />
        ...
        <SidebarContent>
          <div className="px-2 py-1">
            <div className="text-xs font-semibold uppercase text-sidebar-foreground/60 group-data-[collapsible=icon]:hidden">Admin Panel</div>
          </div>
          <SidebarMenu>
            <SidebarMenuItem>
            ...
            <SidebarMenuItem>
              <SidebarMenuButton asChild tooltip="Manage Notices">
                <Link href="/admin/notices"><Newspaper /><span>Notices</span></Link>
              </SidebarMenuButton>
            </SidebarMenuItem>
            <SidebarMenuItem>
        ...
        <header className="flex h-16 items-center justify-between border-b bg-card px-6">
            ...
            <div className="flex items-center gap-3">
                ...
                <Avatar className="h-9 w-9">
                    <AvatarImage src={`https://api.dicebear.com/8.x/initials/svg?seed=${profile.name || "Admin"}`} alt={profile.name || "Admin"} />
